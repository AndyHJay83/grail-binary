...
const SpectatorFilterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4">
      ...
      {currentLetter && (
        <div className="absolute top-4/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50" style={{ marginTop: '500px' }}>
